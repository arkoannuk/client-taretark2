    ...
    <div class="container px-5">
      <div class="max-w-xl text-base-100">
        ...
        <p class="pb-2.5 text-md sm:text-lg">
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Tempore architecto cumque repellat reiciendis maiores quibusdam?
        </p>
        <p class="pb-5 text-md sm:text-lg">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore aliquam impedit, voluptate reiciendis officiis repellat cumque qui error quaerat nisi.
        </p>
        <div>
          <div class="flex gap-1 sm:gap-3 items-end">
            <LightBox btn-classes="btn sm:btn-lg btn-primary btn-primary" />
            <div>
              <p class="text-md sm:text-lg ps-2 font-medium text-end">
                4 max 🧑🏻
              </p>
              <p class="text-md sm:text-lg ps-2 font-medium text-end">
                72 m² 🏠
