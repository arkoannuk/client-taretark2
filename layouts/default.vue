...
<template>
  <div>
    <div class="navbar bg-base-100 sticky top-0 shadow text-base-content " style="z-index: 9999;">
      ...
      <div class="navbar-end">
        <div class="navbar-center hidden md:flex">
          <ul class="menu menu-horizontal px-1">
            <li>
              <NuxtLink to="/booking" @click="removeFocus">
                Broneeri
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/rooms" @click="removeFocus">
                Ruumid
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/about" @click="removeFocus">
                Meist
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/blog" @click="removeFocus">
                Blogi
              </NuxtLink>
            </li>
          </ul>
        ...
        <details class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-300 rounded-box w-max">
        ...
        <details class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-300 rounded-box w-max">
            ...
            <li>
              <NuxtLink to="/rooms" @click="closeAllDetails">
                🏠 Ruumid
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/about" @click="closeAllDetails">
                🧑🏻 Meist
              </NuxtLink>
            </li>
            <li>
              <NuxtLink to="/blog" @click="closeAllDetails">
                📕 Blogi
              </NuxtLink>
            </li>
          </ul>
    ...
    <slot />
    <footer class="footer bottom-0 footer-center p-10 pattern-background text-base-content ">
      <aside>
...
.pattern-background {
  ...
  background-image:
    ...
    /* radial-gradient(circle, rgba(255,255,255,0), #EDEDED 50%), */
