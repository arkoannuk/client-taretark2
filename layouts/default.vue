...
<template>
  <div>
    <div class="navbar bg-base-200 sticky top-0 shadow" style="z-index: 9999;">
      ...
      <div class="navbar-end">
        <details class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-26">
    ...
    <footer class="footer bottom-0 footer-center p-10 bg-base-200 text-primary-content">
      <aside>
