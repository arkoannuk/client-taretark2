...
<template>
  <div>
    <div class="navbar bg-base-200 sticky top-0 shadow text-base-content " style="z-index: 9999;">
      ...
      <div class="navbar-end">
        ...
        <details class="dropdown dropdown-end">
          ...
          <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-300 rounded-box w-26">
            <li><a @click="closeAllDetails">English</a></li>
            <li><a @click="closeAllDetails">Estonian</a></li>
          </ul>
        </details>
        <details class="dropdown dropdown-end">
